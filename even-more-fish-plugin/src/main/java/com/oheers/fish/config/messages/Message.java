...
public class Message {
    ...
    public String getString(String normal, String... ids) {
        for (String id : ids) {
            if (!EvenMoreFish.msgs.getConfig().contains(id)) continue;
            String returning = EvenMoreFish.msgs.getConfig().getString(id);
    ...
    public List<String> getStringList(List<String> normal, String... ids) {
        for (String id : ids) {
            if (!EvenMoreFish.msgs.getConfig().contains(id)) continue;
            List<String> returning = EvenMoreFish.msgs.getConfig().getStringList(id);
