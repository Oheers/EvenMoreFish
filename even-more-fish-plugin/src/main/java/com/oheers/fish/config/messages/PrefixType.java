...
public enum PrefixType {
    ...
    public String getPrefix() {
        if (id == null) return "";
            ...
            return new Message(Messages.getInstance().getConfig().getString(id, normal)).getRawMessage(false, false)
                    + new Message(Messages.getInstance().getConfig().getString("prefix", "[EvenMoreFish]") + "&r").getRawMessage(false, false);
        }
    }
}
